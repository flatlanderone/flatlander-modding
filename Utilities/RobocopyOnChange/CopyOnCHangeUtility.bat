...
echo --------------------------------------------------------
echo Welcome to the Copy On Change Utility Utility!
echo --------------------------------------------------------
...
rem if not exist "%APPDATA%\7DaysToDie\Mods\SAMPLEMODFOLDER" mkdir "%APPDATA%\7DaysToDie\Mods\SAMPLEMODFOLDER"

robocopy "%~dp0\SAMPLEMODFOLDER" "%APPDATA%\7DaysToDie\Mods\SAMPLEMODFOLDER" /v /e /mir /mon:1
